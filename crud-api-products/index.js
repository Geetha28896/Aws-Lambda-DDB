...
exports.handler = async function (event) {
  ...
  switch (true) {
    ...
    case event.httpMethod === "DELETE" && event.path === productPath:
      ...
      break;
    default:
      response = buildResponse(404, " 404 File not Found");
  }
  return response;
};
...
//Get all products from the product inventory table
...
//create product and save to the ddb
...
//modify Product based on the Id
async function modifyProduct(productId, updateKey, updateValue) {
  ...
  return await dynamodb
    ...
    .then(
      ...
      (error) => {
        console.error(
          "Do your custome error handling here. I am just gonna log in",
          error
        );
      }
    );
